...
public class Tandem2mzidRegressionTests extends TestCase {
    ...
    public void test_modifications_and_decoyMatches() throws Exception {
        ...
        new Tandem2mzid(xTandemFile, resultFile, "MS:1001348", "MS:1000584", isMs2SpectrumIdStartingAtZero, true, MzidVersion.Version1_1);
    ...
    public void test_constructors() throws Exception {
        ...
        new Tandem2mzid(xTandemFile, resultFile, "MS:1001349", "MS:1000566", false, true, MzidVersion.Version1_1);
