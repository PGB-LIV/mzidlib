...
public class SpectraFeature extends SpectraBaseInfo{
	...
	/**
	 * @deprecated
	 * Mascot score (always on), IonScore
	 */
	private double mScore=0;
	/**
	 * @deprecated
	 * Mascot score minus Mascot score of next best non-isobaric peptide hit, rank1-rank2 with inequal seq
	 */
	...
	/**
	 * Calculated minus observed peptide mass, after eliminating possible isotope errors up to 2 Da, in Da
	 */
	private double isoDM=0;
	/**
	 * Calculated minus observed peptide mass, after eliminating possible isotope errors up to 2 Da, in ppm
	 */
	private double isoDMppm=0;
	/**
	 * @deprecated
	 * Number of missed cleavages (always 0 if no enzyme)
	 */
	private int mcNum=0;
	/**
	...
	/**
	 * The number of variable mods used in the peptide.
	 * That is, if there are 10 Met and 5 of these are oxidised, this counts as 1. A peptide with Met-OX, phosphoS, deamidation, and acetylation, would count as 5.
	 */
	...
	/**
	 * Log total ion intensity. 
	 * The 20 most intense peaks in each 100 Da bin are used for all features, and totInt reports this value
	 */
	...
	/**
	 * Total matched ion intensity divided by total ion intensity as a percentage (no logs involved)
	 */
	...
	/**
	 * @deprecated
	 * 2nd order polynomial fit to m/z vs delta. Result is RSquared multiplied by the number of points divided by 100
	 */
	private double fragDeltaPolyFit=0;
	/**
	 * Longest sequence matched ions, reported separately for each ion series (backbone only), as with fracIonsMatched
	 */
	...
	/**
	 * A tab separated list of accessions of proteins that contain this peptide. Must be last feature in list
	 */
	...
	/**
	 * @deprecated
	 * log10-value of the sum of all the fragment ion intensities.
	 */
	...
	/**
	 * @deprecated
	 * XTandem's score for the peptide Identification
	 */
	private double hyperScore=0;
	/**
	 * @deprecated
	 * The HyperScore of the second best peptide match of the spectrum 
	 */
	private double nextScore=0;
	/**
	 * @deprecated
	 * The difference of HyperScore between the best and the second best peptide matches
	 */
	...
	/**
	 * @deprecated
	 * The summed intensities  of b-ions
	 */
	private double bScore=0;
	/**
	 * @deprecated
	 * The summed intensities  of y-ions
	 */
	private double yScore=0;
	/**
	 * @deprecated
	 * The number of peaks that matched between the theoretical and the test mass spectrum, b-ions
	 */
	private int bions=0;
	/**
	 * @deprecated
	 * The number of peaks that matched between the theoretical and the test mass spectrum, y-ions
	 */
	private int yions=0;
	/**
	 * @deprecated
	 * The fraction of fragment ions being matched in an ion series (y, b ion series)
	 */
	...
	/**
	 * @deprecated
	 * Matched fragment ion intensity
	 */
