...
public class OMSSAFeatures extends SpectrumBasicInfo implements Feature {
	...
	/**
	 * the ratio of sites with variable modification against potential variable modification sites in a peptide.
	 */
	...
	/**
	 * the interquartile range of delta masses of all matched fragment ions in ppm.
	 */
	...
	/**
	 * an integer array of the percentage of intensity of all matched ion series.
	 */
