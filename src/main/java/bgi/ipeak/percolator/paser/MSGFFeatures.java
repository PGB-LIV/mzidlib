...
public class MSGFFeatures extends SpectrumBasicInfo{
	...
	/**
	 * Summed intensity of identified fragment ions, divided by that of all fragment ions, logged
	 */
	private double lnExplainedIonCurrent=0.0;
	/**
	 * Summed intensity of identified N-terminal fragments, divided by that of all identified fragments, logged
	 */
	...
	/**
	 * Absolute value of the difference between theoretical and experimental mass
	 */
	private double absDeltaMass=0.0;
	/**
	 * Mean of mass errors of the seven fragment ion peaks with the highest intensities.
	 */
	...
	/**
	 * Standard deviation of mass errors of the seven fragment ion peaks with the highest intensities
	 */
