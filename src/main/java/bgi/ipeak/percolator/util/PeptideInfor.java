...
public class PeptideInfor {
    ...
    /**
     * The identity threshold, when the peptideHitScore is above this threshold
     * it will tagged as an identification.
     */
    ...
    /**
     * @deprecated The start position of the peptide in the mapped protein,
     * 1-based.
     */
    private int proStart = 0;
    /**
     * @deprecated The end position of the peptide in the mapped protein,
     * 1-based.
     */
