...
public interface Feature {
    ...
    /**
     * Return the ratio of sites with variable modification against potential
     * variable modification sites in a peptide.
     *
     * @return the ratio of sites with variable modification against potential
     * variable modification sites in a peptide.
     */
    ...
    /**
     * Return the interquartile range of delta masses of all matched fragment
     * ions.
     *
     * @return the interquartile range of delta masses of all matched fragment
     * ions.
    ...
    /**
     * Return an integer array of the fraction of all matched ion series. The
     * fraction equals to the number of matched fragment ions derived from the
     * same ion series, e.g. b, y, divided by the peptide length minus one.
     *
    ...
    /**
     * Return an integer array of the percentage of intensity of all matched ion
     * series. The total intensity of each ion series is divided by that of all
     * matched fragment ions.
     *
     * @return an integer array of the percentage of intensity of all matched
     * ion series.
     */
