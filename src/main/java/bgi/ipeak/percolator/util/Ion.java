...
public interface Ion {
    ...
    /**
     * This method returns the soft type int ID of the fragment ion. e.g. an A-ion has an integer ID = 0.
     * <br><b>A-ion : 0</B>
     * <br><b>A++-ion : 1</B>
     * <br><b>B-ion : 2</B>
     * <br><b>B++-ion : 3</B>
    ...
    public int getID();
    /**
     * Return the type of the fragment ion. (e.g. a b3 fragment ion will have String iType = "b")
     *
     * @return String   Return a String with the type of fragment ion.
     */
    public String getType();
    /**
     * Return the sub index of the fragment ion. (e.g. a b3 fragment ion will have Number = 3)
     *
     * @return the sub index of the fragment ion. (e.g. a b3 fragment ion will have Number = 3)
     */
    ...
    /**
     * Return the mass error between the theoretical fragment ion and the matched peak in dalton.
     * <b>The fragment ion must be a match in the mass spectrum before this method can be used!</b>
     *
     * @return the mass error between the theoretical fragment ion and the matched peak in dalton.
     */
