...
/**
 * This class contains some utility methods related to the Controlled Vocabulary (CV) at
 * 
...
public class CVUtils 
{
	...
	/**
	 * Tries to infer the correct CV term id and name based on the extension of the given databaseFileName.
	 * It falls back to ["MS:1001348","FASTA format"] if it cannot infer the format based on the extension.
	 * 
	 * @param databaseFileName : the file reported as the protein database where the ms/ms search was done.
	 * 
	 * @return : returns an array with 2 strings, the first one being the CV term id and the second one the name.
	 */
	public static String[] getDatabaseFileFormat(String databaseFileName)
	{
		...
		else if (databaseFileName.toLowerCase().contains("formatdb"))
		{//TODO: not sure what the extension would be here...
	...
	/**
	 * Tries to infer the correct CV term id and name based on the extension of the given spectrumFileName.
	 * It falls back to the generic ["MS:1000560","mass spectrometer file format"] if it cannot infer the format based on the extension.
	 * 
	 * @param spectrumFileName : the file reported as the ms spectra file that contained the ms/ms spectra.
	 * 
	 * @return : returns an array with 2 strings, the first one being the CV term id and the second one the name.
	 */
	public static String[] getMassSpecFileFormatID(String spectrumFileName)
	{
		...
		else if (spectrumFileName.toLowerCase().contains(".dta"))
		{//TODO not sure about the extension
